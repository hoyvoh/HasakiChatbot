...
import time
from pc_utils import time_it_ms, create_vector_emb, get_similar_metrics, get_pids_from_pc_response
...
if __name__ == '__main__':
    ...
    res = pc.query_index_name_to_id(query=query, topk=3)
    scores = get_similar_metrics(query=query, query_response=res)
    print(scores)
